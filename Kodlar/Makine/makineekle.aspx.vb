...
Partial Class makineekle
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        If FileUpload1.HasFile Then
            ...
            FileUpload1.SaveAs(Server.MapPath("makine\" + dosyaad))
        End If
        baglanti.Open()
        Dim cmd As New OleDbCommand
        cmd.CommandText = "insert into makine(Model,Açıklama,Resim)values(@Model,@Açıklama,@Resim)"
        ...
        cmd.Parameters.Add("@Resim", OleDbType.VarChar).Value = "makine\" & dosyaad
        cmd.ExecuteNonQuery()
